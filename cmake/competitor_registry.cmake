...
if(BUILD_TESTING)
  ...
  if(Python3_Interpreter_FOUND)
    ...
    add_test(
      NAME m7-physical-browser-full-set-tests
      COMMAND
        "${Python3_EXECUTABLE}"
    ...
    add_test(
      ...
      COMMAND
        "${Python3_EXECUTABLE}"
        "${CMAKE_CURRENT_SOURCE_DIR}/scripts/m7_admission_replay_tests.py")
    add_test(
      NAME m7-admission-replay-v3-tests
      COMMAND
        "${Python3_EXECUTABLE}"
        "${CMAKE_CURRENT_SOURCE_DIR}/scripts/m7_admission_replay_v3_tests.py")
    add_test(
    ...
    add_test(
      NAME m7-evidence-bundle-manifest-v3-tests
      COMMAND
        "${Python3_EXECUTABLE}"
        "${CMAKE_CURRENT_SOURCE_DIR}/scripts/m7_evidence_bundle_manifest_v3_tests.py")
  else()
    foreach(_test_name IN ITEMS
        ...
        m7-admission-replay-v3-tests
        m7-evidence-bundle-manifest-tests
        m7-evidence-bundle-manifest-v3-tests)
