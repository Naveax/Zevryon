...
if(BUILD_TESTING)
  ...
  add_executable(
    zevryon-html-tokenizer-data-canonical-v1-tests
    tests/html_tokenizer_data_canonical_v1_tests.cpp)
  target_link_libraries(
    zevryon-html-tokenizer-data-canonical-v1-tests
    PRIVATE zevryon-massivedoc-core)
  zevryon_options(zevryon-html-tokenizer-data-canonical-v1-tests)
  add_test(
    NAME html-tokenizer-data-canonical-v1-tests
