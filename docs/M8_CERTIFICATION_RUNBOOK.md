...
The binder-v2 machinery described here is admitted on canonical `main` by PR #143.

Admission authority:

- exact candidate head: `183eb00a45e92a3a3a4dcd5d7fc6b8eeca60495a`;
- exact candidate tree: `c2e8669707e318311e00197186663947d676382f`;
- natural exact-head PR run: `34141947892` — 7/7 SUCCESS;
- canonical squash commit: `ba02e59f47cdbf5314d5eca4c51282aac9a78e68`;
- canonical tree: `c2e8669707e318311e00197186663947d676382f`.

Admission of the machinery is not certification evidence. A production PASS still requires the real Titan, four physical profile attempts and every long-running axis in one fresh frozen bundle.
...
## 1. Pin one clean canonical candidate
