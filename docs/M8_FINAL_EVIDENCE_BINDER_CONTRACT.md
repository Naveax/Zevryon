...
The v2 stack adds provenance-bound import of four independently collected physical profile attempts while preserving raw recomputation authority for storage crash, mixed mutation, continuous soak and four-domain property fuzz.

## Admission boundary

Binder v2 is admitted to canonical `main` by PR #143.

Admission evidence:

- exact candidate head: `183eb00a45e92a3a3a4dcd5d7fc6b8eeca60495a`;
- candidate tree: `c2e8669707e318311e00197186663947d676382f`;
- exact-head natural PR run: `34141947892` — 7/7 SUCCESS;
- canonical squash commit: `ba02e59f47cdbf5314d5eca4c51282aac9a78e68`;
- canonical tree after squash: `c2e8669707e318311e00197186663947d676382f`.

A candidate implementation, merge admission or short CI smoke is never final certification evidence. Final certification still requires one complete real evidence bundle produced under this contract.
...
The bundle stores compact support documents rather than copying the multi-gigabyte Titan container four times. Support evidence includes:
...
The short CI smoke can never satisfy this gate.
