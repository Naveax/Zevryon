...
''',
    ...
    if "\\x00" in input_text:
        if state_name in {
            ...
            return "input-preprocessing-nul"
''',
    "stacked comment NUL classifier",
)
path.write_text(text, encoding="utf-8")

print("applied stacked normal-comment NUL diagnostic patch")
