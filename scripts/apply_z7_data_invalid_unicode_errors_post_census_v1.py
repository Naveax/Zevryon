...
text = path.read_text(encoding="utf-8")
if text.count("MAX_SAMPLES = 25") != 1:
    raise SystemExit("MAX_SAMPLES anchor drift")
path.write_text(text.replace("MAX_SAMPLES = 25", "MAX_SAMPLES = 200", 1), encoding="utf-8")
print("applied Data invalid-Unicode candidate and expanded failure census")
