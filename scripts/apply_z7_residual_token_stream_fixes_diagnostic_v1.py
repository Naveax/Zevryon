...
# WHATWG unquoted attribute-value state: '/' is ordinary data, even before '>'.
...
# Comment EOF/end-bang semantics for the seven residual token mismatches.
...
path.write_text(text, encoding="utf-8")
print("applied residual token-stream diagnostic fixes")
