...
def main() -> int:
    ...
    require(
        ...
        "complete comparable successful set was not leadership eligible",
    )
    ...
    require(mismatch["leadership_eligible"] is False, "scenario mismatch allowed leadership")
    require(
    ...
    require(system_mismatch["leadership_eligible"] is False, "system mismatch allowed leadership")
    require(
    ...
    require(host_mismatch["leadership_eligible"] is False, "host mismatch allowed leadership")
    require(
