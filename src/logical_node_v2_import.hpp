...
// Imports a fully validated ZVNSRC01 v2 source into the isolated ZVNODA v2
// arena. Validation completes before arena staging begins, so an invalid source
// cannot create node-arena-v2.building/ or publish node-arena-v2/.
