...
int main() {
    ...
    const bool example1 = check_example(
        ...
        }),
        {
            ...
            {{2U}, 1U, BidiClass::R, BidiClass::L},
            {{4U}, 2U, BidiClass::L, BidiClass::L},
            {{6U}, 1U, BidiClass::L, BidiClass::R},
            {{8U}, 0U, BidiClass::R, BidiClass::L},
        },
        &sequence_total);
    ...
    const bool example2 = check_example(
        ...
        make_codepoints({
            ...
            0x05d1U, 0x2069U, 0x2067U, 0x05d2U, 0x2069U, 'c',
        }),
        {
            {{0U, 1U, 7U, 8U, 10U, 11U}, 0U, BidiClass::L, BidiClass::L},
            {{2U, 3U, 5U, 6U}, 1U, BidiClass::R, BidiClass::R},
            {{4U}, 2U, BidiClass::L, BidiClass::L},
            {{9U}, 1U, BidiClass::R, BidiClass::R},
        },
        &sequence_total);
    ...
    const bool example3 = check_example(
        "UAX9-X10-example-3",
        make_codepoints({
            'a', 0x202bU, 0x05d0U, 0x2066U, 'b', 0x202bU,
            0x05d1U, 0x2069U, 0x05d2U, 0x202cU, 'c',
        }),
        {
            {{0U}, 0U, BidiClass::L, BidiClass::R},
            {{2U, 3U, 7U, 8U}, 1U, BidiClass::R, BidiClass::R},
            {{4U}, 2U, BidiClass::L, BidiClass::R},
            {{6U}, 3U, BidiClass::R, BidiClass::R},
            {{10U}, 0U, BidiClass::R, BidiClass::L},
        },
        &sequence_total);
